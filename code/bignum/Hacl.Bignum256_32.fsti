...
"Write `a + b mod 2^256` in `output`.
  ...
  The arguments a, b and output are meant to be 256-bit bignums, i.e. uint32_t[8]"]
...
[@@ Comment "Write `(a + b) mod n` in `output`.
  ...
  The arguments a, b, n and the outparam output are meant to be 256-bit bignums, i.e. uint32_t[8].
...
[@@ Comment "Write `a * b` in `output`.
  ...
  The outparam output is meant to be a 512-bit bignum, i.e. uint32_t[16]."]
...
[@@ Comment "Write `a mod n` in `output`.
  ...
  The argument n and the outparam output are meant to be 256-bit bignums, i.e. uint32_t[8].
...
[@@ Comment "Write `a ^ b mod n` in `output`.
  ...
  The arguments a, n and the outparam output are meant to be 256-bit bignums, i.e. uint32_t[8].
...
[@@ Comment "Write `a mod n` in `output`.
  ...
  The argument a is meant to be a 512-bit bignum, i.e. uint32_t[16].
  The outparam output is meant to be a 256-bit bignum, i.e. uint32_t[8].
  The argument ctx is a montgomery context obtained through Hacl_Bignum256_mont_ctx_init."]
val mod_precomp: BS.bn_mod_slow_ctx_st t_limbs n_limbs

[@@ Comment "Write `a ^ b mod n` in `output`.

  The arguments a and the outparam output are meant to be 256-bit bignums, i.e. uint32_t[8].
  The argument ctx is a montgomery context obtained through Hacl_Bignum256_mont_ctx_init.
...
[@@ Comment "Write `a ^ (-1) mod n` in `output`.
  ...
  The argument a and the outparam output are meant to be 256-bit bignums, i.e. uint32_t[8].
  The argument ctx is a montgomery context obtained through Hacl_Bignum256_mont_ctx_init.
