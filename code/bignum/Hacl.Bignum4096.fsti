...
"Write `a + b mod 2^4096` in `output`.
  ...
  The arguments a, b and output are meant to be 4096-bit bignums, i.e. uint64_t[64]"]
...
[@@ Comment "Write `(a + b) mod n` in `output`.
  ...
  The arguments a, b, n and the outparam output are meant to be 4096-bit bignums, i.e. uint64_t[64].
...
[@@ Comment "Write `a * b` in `output`.
  ...
  The outparam output is meant to be a 8192-bit bignum, i.e. uint64_t[128]."]
...
[@@ Comment "Write `a mod n` in `output`.
  ...
  The argument n and the outparam output are meant to be 4096-bit bignums, i.e. uint64_t[64].
...
[@@ Comment "Write `a ^ b mod n` in `output`.
  ...
  The arguments a, n and the outparam output are meant to be 4096-bit bignums, i.e. uint64_t[64].
...
[@@ Comment "Write `a mod n` in `output`.
  ...
  The argument a is meant to be a 8192-bit bignum, i.e. uint64_t[128].
  The outparam output is meant to be a 4096-bit bignum, i.e. uint64_t[64].
  The argument ctx is a montgomery context obtained through Hacl_Bignum4096_mont_ctx_init."]
val mod_precomp: BS.bn_mod_slow_ctx_st t_limbs n_limbs

[@@ Comment "Write `a ^ b mod n` in `output`.

  The arguments a and the outparam output are meant to be 4096-bit bignums, i.e. uint64_t[64].
  The argument ctx is a montgomery context obtained through Hacl_Bignum4096_mont_ctx_init.
...
[@@ Comment "Write `a ^ (-1) mod n` in `output`.
  ...
  The argument a and the outparam output are meant to be 4096-bit bignums, i.e. uint64_t[64].
  The argument ctx is a montgomery context obtained through Hacl_Bignum4096_mont_ctx_init.
